                ...
                <form onSubmit={handleAddService} className="space-y-4 mx-5 ">
                    ...
                    <div className='lg:flex gap-3 mx-2 lg:mx-0 '>
                        <div>
                            ...
                            <input onChange={handleFieldValue} type="text" name="title" id="title" placeholder="Enter Your Name" className="w-full px-4 py-3 rounded-md text-gray-900" />
                        </div>
                        <div>
                            <label htmlFor="serviceImg" className="text-md font-semibold">Service Image</label>
                            <input onChange={handleFieldValue} type="text" name="serviceImg" id="serviceImg" placeholder="Service Image URL/Link" className="w-full px-4 py-3 rounded-md text-gray-900" />
                    ...
                    <div className='grid grid-cols-2 lg:grid-cols-4 gap-3 mx-2 lg:mx-0 '>
                        <div>
                            ...
                            <input onChange={handleFieldValue} type="digit" name="fees" id="fees" placeholder="E.g. $200 Fees" className="w-full px-4 py-3 rounded-md text-gray-900" />
                        </div>
                        <div>
                            <label htmlFor="completed" className="text-md font-semibold">Completed Case</label>
                            <input onChange={handleFieldValue} type="digit" name="completed" id="completed" placeholder="E.g. 320 Case" className="w-full px-4 py-3 rounded-md text-gray-900" />
                        </div>
                        <div>
                            <label htmlFor="rating" className="text-md font-semibold">Rating</label>
                            <input onChange={handleFieldValue} type="number" name="rating" id="rating" placeholder="E.g. 4.9" className="w-full px-4 py-3 rounded-md text-gray-900" />
                        </div>
                        <div>
                            <label htmlFor="totalRate" className="text-md font-semibold">Total Feedback</label>
                            <input onChange={handleFieldValue} type="digit" name="totalRate" id="totalRate" placeholder="E.g. 490" className="w-full px-4 py-3 rounded-md text-gray-900" />
                        </div>
                    </div>
                    <div className="space-y-1 text-lg mx-2 lg:mx-0">
                        ...
                        <textarea onChange={handleFieldValue} name="description" id="description" placeholder="Write Service Details" className="w-full px-4 py-3 rounded-md text-gray-900" />
                    </div>
